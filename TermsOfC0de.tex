...
\chapter{役員}
    \section{役員}\label{directors}
        \begin{enumerate}
            \item 当部は部の円滑な運営のために以下の役職をもつ部員である役員をおくものとする。
            \begin{itemize}
                \item 部長（1名）：当部の代表
                \item 副部長（1名）：部長の補佐
                \item 会計（1名）：部費の管理
                \item 庶務（1名以上3名以下）：行事の運営
            \end{itemize}
            \item 役員の任期は当規約\ref{activity}1項にて定められた活動期間とする。
            \item 部会にて当規約\ref{decision}に基づいた承認を得ることで、新たな役職を持つ役員をおくこと、役員の定員を変更することができる。
            \item 各役員は各役職を兼任することができる。
        \end{enumerate}
...
\chapter{その他}
    ...
    \section*{発行}
        ...
        \begin{itemize}
            ...
            \item 令和5年（2023年）1月n日：役員についての改定
        \end{itemize}
